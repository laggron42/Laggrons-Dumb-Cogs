...
INIT_FILE_PREFIX = (
    "# This file was generated by instantcmd for making this folder a module\n"
    "# You may overwrite this as you want, or manually add files here\n\n"
)
SHARED_FILE_PREFIX = (
    '# This file was generated by instantcmd using the "instantcmd shared add" command\n'
    "# Initiated by {author}\n"
    "# You may overwrite this as you want\n\n"
)
...
class InstantCommands(BaseCog):
    ...
    def __init__(self, bot: Red):
        ...
        self.listeners = {}
        self.path = cog_data_path(self) / "instantcmd"
    ...
    async def _extract_code(
        ...
        code_type: CodeType = CodeType.INSTANTCMD,
        path=None,
    ):
        if ctx.message.attachments:
            ...
            if code_type == CodeType.INSTANTCMD:
                message = (
            ...
            elif code_type == CodeType.ENV_VALUE:
                message = (
                ...
                message = (
                    "You're about to add a new shared code snipped.\n"
                    "Your next message will be the code for the file at `shared/{path}.py`"
...
takes the context as its sole parameter.
        """
        function = await self._extract_code(ctx, code, CodeType.ENV_VALUE)
        if function is None:
            return
        function, function_string = function
        # if the user used the command correctly, we should have one async function
