...
reformat:
	@echo "Starting..."
	@python3 -m black -l 100 --skip-numeric-underscore-normalization `git ls-files "*.py"`

stylecheck:
	@echo "Starting..."
	@python3 -m black -l 100 --skip-numeric-underscore-normalization --check --diff `git ls-files "*.py"`
